...
> Status: Phase 1 MVP. Commands below are implemented and tested. More land per
> `docs/STATUS.md`.
...
`--gate new-only`, SARIF output, `fix`, framework entry-point plugins, `.mollifyrc`
being read by analysis. Tracked in `docs/STATUS.md`.
