...
const ENTRY_DECORATORS: &[&str] = &[
    ...
    "websocket", "websocket_route", "middleware", "exception_handler",
    "on_event", "before_request", "after_request", "errorhandler",
    // Task queues (Celery, RQ, Dramatiq, Huey, APScheduler)
    "task", "shared_task", "periodic_task", "actor", "scheduled_job",
    ...
    "receiver", "register", "display", "action", "simple_tag", "filter",
    "inclusion_tag", "admin",
    // CLI (click, typer)
    ...
    "hook", "plugin", "rule", "event", "listener", "handler", "provides",
    "implementer", "setup", "teardown",
];
